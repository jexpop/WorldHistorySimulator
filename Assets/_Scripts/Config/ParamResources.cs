...
{  
    ...
    /* Csv */
    public static string CSV_GEOGRAPHIC_PATH = "/GeographicData/";
    public static string CSV_GEOGRAPHIC_TABLE_REGIONS = "Region.csv";
    public static string CSV_GEOGRAPHIC_TABLE_TERRAIN_TYPES = "TerrainType.csv";
    public static string CSV_GEOGRAPHIC_TABLE_TERRAINS = "Terrain.csv";
